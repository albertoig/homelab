## [1.0.1](https://github.com/albertoig/homelab/compare/v1.0.0...v1.0.1) (2026-06-21)
...
* **charts:** set OAuth2 provider grant_types for the SSO blueprint ([3cc1949](https://github.com/albertoig/homelab/commit/3cc19495f11360421ac1fa0b50f24ed381fbb1aa))
* **ci:** handle force-push in commitlint by checking ancestor before using FROM sha ([f6e45b6](https://github.com/albertoig/homelab/commit/f6e45b602246b857c750fa58e4c6ab5d8ad21b64))
...
* **grafana:** use Recreate strategy to prevent RWO multi-attach errors ([81cd5cf](https://github.com/albertoig/homelab/commit/81cd5cf5860db9c1677344b884cc3b9a170c2271))
...
* **helmfile:** create the OpenBao ServiceMonitor under serverTelemetry ([945b611](https://github.com/albertoig/homelab/commit/945b611e1f32aadfaecb5805e56cdefd6938c998))
* **helmfile:** use a sane prometheus_retention_time for OpenBao telemetry ([cbbea05](https://github.com/albertoig/homelab/commit/cbbea0577593140f959754505a8cb988065d469e))
...
* **metal:** pin all Ansible Galaxy collection versions to avoid API lookup errors ([49b8297](https://github.com/albertoig/homelab/commit/49b829734d04efcd6a43efe403f6b29a77b03c83))
...
* **mise:** auto-init Terraform backend before workspace select and apply ([65516fd](https://github.com/albertoig/homelab/commit/65516fd6b01f0c295c8d2a6f4c241695340c24b9))
...
* **mise:** correct kubectl version, add pipx as explicit dependency ([87e8081](https://github.com/albertoig/homelab/commit/87e80819f8c15382709b22966d504b4a26a7902c))
...
* **mise:** move install/destroy logic to scripts so env arg is passed correctly ([e61f1ad](https://github.com/albertoig/homelab/commit/e61f1adc2aeaeb606fb8d3b6e786ba9a7df02396))
...
* **mise:** replace source with . for POSIX sh compatibility and use return in sourced script ([2dcee83](https://github.com/albertoig/homelab/commit/2dcee83089bef35d516bc65997551972083abe98))
...
* **mise:** replace uvx with poetry for Python tool management ([fdd9a78](https://github.com/albertoig/homelab/commit/fdd9a782ea898ee1d6e4c2d47a07cb91c9333708))
...
* **mise:** switch Python tools from pipx to uvx backend ([1c37a9f](https://github.com/albertoig/homelab/commit/1c37a9f27866056d76e3162ff95c35b80c4b16c3))
...
* **mise:** use CLOUDFLARE_ACCOUNT_ID to derive R2 endpoint and account ID for Terraform ([f5fb4a8](https://github.com/albertoig/homelab/commit/f5fb4a8d162ef7407db98c43a693efe1e2331fc3))
...
* **mise:** use TF_WORKSPACE and single-line tasks to fix env arg across all terraform commands ([8449eaf](https://github.com/albertoig/homelab/commit/8449eaf9dd53d28d3d0e88976a5e9f98dbf61c16))
...
* **terraform:** extract R2 credential mapping to scripts/lib/terraform-env.sh ([360835b](https://github.com/albertoig/homelab/commit/360835bf555177ce598cfeee3e36c3757ad8eac9))
...
* **terraform:** replace deprecated force_path_style and skip backend when credentials absent ([beea772](https://github.com/albertoig/homelab/commit/beea77297d7a15a27928820280d7c954175011a2))
...
* **terraform:** use -migrate-state on init and skip AWS account ID lookup for R2 ([9656be9](https://github.com/albertoig/homelab/commit/9656be9998591cd30c5b5e426111430fa683d2a7))
...
* **terraform:** use CLOUDFLARE_R2_* vars instead of AWS_* for R2 state backend ([5d22bff](https://github.com/albertoig/homelab/commit/5d22bffda8a3ad4a8f0c6fa08babe876404fd84f))
...
* add animated image header to CLI scripts via viu ([e4e9d44](https://github.com/albertoig/homelab/commit/e4e9d446c8004872bbc4ebcbbec05da61b99c571))
...
* add velero secrets automation and fix terraform workspace selection ([5089c7b](https://github.com/albertoig/homelab/commit/5089c7b48c9f9dbc772868bcf29cd928ac5b766c))
...
* **check:** add side-by-side Tools and Secrets boxes with env-scoped secrets check ([f834bd0](https://github.com/albertoig/homelab/commit/f834bd08a13267be5acc29fd00b3751be1c01f4a))
...
* **check:** redesign requisites UI with gum spin pulse and section ticks ([0bf30f3](https://github.com/albertoig/homelab/commit/0bf30f3a388f2fa6139f4ddcbc1ad13cb52e4aac))
...
* **helmfile:** add Velero backup with Cloudflare R2 ([41a4e55](https://github.com/albertoig/homelab/commit/41a4e556d3abb2f156afd561d944cc9c46e56ec1))
...
* **helmfile:** wire OpenBao into the observability stack ([917e08e](https://github.com/albertoig/homelab/commit/917e08e75596a3a9b93c9cca90206f1e335a02b8))
* **install:** replace banner with hypercrush-style ASCII art header ([20311fb](https://github.com/albertoig/homelab/commit/20311fb8244e5f559cb6b542b1052869831b34ed))
...
* **makefile:** add setup target for full environment bootstrap ([598aa52](https://github.com/albertoig/homelab/commit/598aa52233fc22a196aaf62a469e45ffd010299d))
...
* **makefile:** run terraform apply/destroy alongside helmfile install/destroy ([0758277](https://github.com/albertoig/homelab/commit/0758277e04ab4ff8da6ff14e22b30fb69291e6f1))
...
* **mise:** add clean task to remove build artifacts and caches ([4ec2d44](https://github.com/albertoig/homelab/commit/4ec2d44946fdfd4568725d3ee3204b9b22408229))
...
* **mise:** add mise for tool version management ([8ac0a23](https://github.com/albertoig/homelab/commit/8ac0a23f2734660e252c48dbeea7508d8b2fafb8))
...
* **openbao:** add openbao:unseal command for restart/reboot recovery ([6d42d07](https://github.com/albertoig/homelab/commit/6d42d07a0596f67e25b3756894f6ff262320af75))
...
* **terraform:** add Cloudflare R2 bucket for Velero backups ([a659e05](https://github.com/albertoig/homelab/commit/a659e05f687e92a6a8cf2345d9d568f737fbeed6))
...
* **terraform:** add Cloudflare R2 remote state backend via environment variables ([bdaa83b](https://github.com/albertoig/homelab/commit/bdaa83bc8303acb9bd75e187b4c07863391252cf))
...
* **terraform:** scope R2 bucket and Terraform state per environment via workspaces ([6f370c3](https://github.com/albertoig/homelab/commit/6f370c343c4b2650d05a0d33dbfa7c007c412be5))
